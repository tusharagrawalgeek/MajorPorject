...
function SideBar2(props) {
  ...
  function handleClick(event) {
    ...
    if (props.selectedState !== name) return props.changeState(name);
  }
        ...
        >
          <table style={{ margin: "auto", borderSpacing: 1, height: "100%" }}>
            ...
            <tr>
              <td>
                <h5>
                  <button className="btn-sidebar">Upload Documents</button>
                </h5>
              </td>
            </tr>
            <tr>
